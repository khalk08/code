...
var boy, boyImg, boy_running, ground, groundImg;
...
function preload(){
   ...
   boy_running = loadAnimation("homeboy.png", "homeboy2.png", "homeboy3.png");
...
function setup(){
  ...
  boy = createSprite(windowHeight, windowWidth-10, 20);
